...
{{--*/
 ...
 /*--}}
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top " role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar " role="navigation">
             ...
             <li class="s-link {{ (Request::segment(2)==$value['url'])?'active':'' }}">
                               ...
                               @endif
                               @endforeach
                            <li id="setting" class="{{ (Request::url() === url('panel/setting')) ? 'active' : '' }}">
                                <a  href="{{ url('panel/setting') }}" ><i class="fa fa-gears"></i> &nbsp Setting </a> <span class="badge pull-right">CJ</span>
                            <li>
                      </ul>
        ...
        <div id="page-wrapper" style="height:900px !important;">
