...
(function( $ ) {
	...
	jQuery(window).ready(function() {
		...
		jQuery(".tab-b").each(function(){
			jQuery(this).find("h3").eq(0).addClass("active");
		});

		jQuery(".tab-b h3").click(function(){
			var thisel = jQuery(this);
			var thisindex = thisel.index();
			thisel.addClass("active").siblings("h3.active").removeClass("active");
			thisel.parent().siblings(".tab-d").children("div").eq(thisindex).addClass("active").siblings("div.active").removeClass("active");
		...
		// Tabbed blocks
		jQuery(".short-tabs.aaa").each(function() {
			var thisel = jQuery(this);
			thisel.children("div").eq(0).addClass("active");
			thisel.children("ul").children("li").eq(0).addClass("active");
		});
		jQuery(".short-tabs.bbb").each(function() {
			var thisel = jQuery(this);
			thisel.children("div").eq(1).addClass("active");
			thisel.children("ul").children("li").eq(1).addClass("active");
		});
		jQuery(".short-tabs.ccc").each(function() {
			var thisel = jQuery(this);
			thisel.children("div").eq(2).addClass("active");
			thisel.children("ul").children("li").eq(2).addClass("active");
		});
		jQuery(".short-tabs.ddd").each(function() {
			var thisel = jQuery(this);
			thisel.children("div").eq(3).addClass("active");
			thisel.children("ul").children("li").eq(3).addClass("active");
		});
		...
		jQuery(".short-tabs2.aaa").each(function() {
			var thisel = jQuery(this);
			thisel.children("div").eq(0).addClass("active");
			thisel.children("ul").children("li").eq(0).addClass("active");
		});
		jQuery(".short-tabs2.bbb").each(function() {
			var thisel = jQuery(this);
			thisel.children("div").eq(1).addClass("active");
			thisel.children("ul").children("li").eq(1).addClass("active");
		});
		jQuery(".short-tabs2.ccc").each(function() {
			var thisel = jQuery(this);
			thisel.children("div").eq(2).addClass("active");
			thisel.children("ul").children("li").eq(2).addClass("active");
		});
		jQuery(".short-tabs2.ddd").each(function() {
			var thisel = jQuery(this);
			thisel.children("div").eq(3).addClass("active");
			thisel.children("ul").children("li").eq(3).addClass("active");
		});

		jQuery(".short-tabs2 > ul > li a").click(function() {
					var thisel = jQuery(this).parent();
					thisel.siblings(".active").removeClass("active");
					thisel.addClass("active");
					thisel.parent().siblings("div.active").removeClass("active");
		...
		// Responsive menu
		jQuery(".main-menu > div").append('<a href="#" class="toggle-menu"><i class="fa fa-ban"></i> Shopping Menu</a>');
		jQuery(".header-topmenu > div").append('<a href="#" class="toggle-menu"><i class="fa fa-ban"></i> Site Menu</a>');
		jQuery(".shopmenu-topmenu > div").append('<a href="#" class="toggle-menu"><i class="fa fa-ban"></i> Sub-Shopping Menu</a>');
		jQuery(".shopmenu-bottommenu > div").append('<a href="#" class="toggle-menu"><i class="fa fa-ban"></i> Sub-Shopping Menu</a>');
		jQuery(".shopmenu-sub-bottommenu > div").append('<a href="#" class="toggle-menu"><i class="fa fa-ban"></i> Sub-Shopping Menu</a>');
...
$NAV = $(this).parent().siblings(".drop-nav-shop");
if($NAV.is(":visible")) {
$NAV.fadeOut("fast");
$(this).removeClass("open");
}
else {
$(".drop-nav-shop").fadeOut(100);
$(".drop-btn a").removeClass("open");
$NAV.slideDown("fast");
$(this).addClass("open");
}
return false;
